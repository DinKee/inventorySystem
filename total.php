            ...
            <tbody class="u-table-body">
              <?php
                ...
                while ($rows = mysqli_fetch_array($sell_result, MYSQLI_ASSOC)) {
                  ...
                  $s_price = $s_price + $rows["tea_num"] * $rows["unit_price"];
                }
                ...
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'></td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'></td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>Sell Order:</td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>".$s_num."</td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>Your Total:</td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>".$s_price."</td>";
                echo "</tr>";
            ...
            <tbody class="u-table-body">
              <?php              
                ...
                while ($rows = mysqli_fetch_array($purchase_result, MYSQLI_ASSOC)) {
                  ...
                  echo "</tr>";
                  $total_price = $total_price - $rows["tea_num"] * $rows["unit_price"];
                  $p_price = $p_price + $rows["tea_num"] * $rows["unit_price"];
                }
                $p_num = mysqli_num_rows($purchase_result);
                $total = $p_num + $s_num;
                echo "<tr style='height: 47px;' class='u-table-footer u-table-footer-1'>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'></td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>Purchase Order:</td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>".$p_num."</td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>Your Total:</td>";
                echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>".$p_price."</td>";
                echo "</tr>";
